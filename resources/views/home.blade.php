...
<!-- Mirrored from html.pixel-industry.com/royal-plate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 08:08:31 GMT -->
...
<head>
        ...
        <!-- Stylesheets -->
        <link rel="stylesheet" href="{{ asset('') }}assets/css/bootstrap.min.css"/><!-- bootstrap grid -->
        <link rel="stylesheet" href="{{ asset('') }}assets/css/bootstrap-theme.min.css"/><!-- bootstrap theme -->
        <link rel="stylesheet" href="{{ asset('') }}assets/css/style.css"/><!-- template styles -->
        <link rel="stylesheet" href="{{ asset('') }}assets/css/color-default.css"/><!-- default template color styles -->
        ...
        <link rel="stylesheet" href="{{ asset('') }}assets/css/animate.css"/><!-- animation for content -->
        <link rel="stylesheet" href="{{ asset('') }}assets/masterslider/style/masterslider.css" /><!-- Master slider css -->
        <link rel="stylesheet" href="{{ asset('') }}assets/masterslider/skins/default/style.css" /><!-- Master slider default skin -->
        <link rel='stylesheet' href="{{ asset('') }}assets/owl-carousel/owl.carousel.css"/><!-- Events carousel -->
        <link rel='stylesheet' href="{{ asset('') }}assets/owl-carousel/owl.theme.css"/><!-- Events carousel -->
...
<!-- Mirrored from html.pixel-industry.com/royal-plate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2024 08:08:40 GMT -->
</html>
